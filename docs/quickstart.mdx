...
OCA works with multiple free AI providers — no credit card needed to get started.

| Provider | Free Models | Free Limit |
|----------|-------------|------------|
| **GitHub Copilot** | GPT-4.1, Claude Sonnet | 2,000/mo · 50/day |
...
→ **[Full guide with setup instructions](/docs/free-models)**
