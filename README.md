...
| <g-emoji class="g-emoji" alias="arrows_counterclockwise">🔄</g-emoji> Auto-Updates | <g-emoji class="g-emoji" alias="wrench">🔧</g-emoji> Master CLI |
|:---:|:---:|
...
│ ── RTX⚡1: install-infra-deps.sh (always)                   │
│ ── RTX⚡2: install-glibc.sh, install-nodejs.sh (conditional)│
│ ── RTX⚡3: Optional tools (user-selected)                   │
├─────────────────────────────────────────────────────────────┤
...
📦 **[View Release Notes](RELEASES/01.04.2026.md)**
